 ...
 *
 * bills table columns: bill_id, customer_name, customer_phone,total_amount, bill_date
 */
public class StoreDataModel {
    ...
    public double getTodaySales() {
        return queryDouble(
                "SELECT IFNULL(SUM(total_amount), 0) FROM bills " +
    ...
    private List<Transaction> loadTransactions(int limit) {
        ...
        String sql =
                "SELECT bill_id, customer_name, total_amount, bill_date " +
                        "FROM bills " +
